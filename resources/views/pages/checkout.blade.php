                ...
                <div class="col-lg-8 pl-lg-0">
                    <div class="card card-details">
                                ...
                                <tbody>
                                    @forelse ($item->details as $detail)
                                        <tr>
                                            ...
                                            <!-- align-middle: untuk mensejajarkan isi tabel dengan gambar-->
                        ...
                        <div class="member mt-3">
                            ...
                            <p class="disclaimer mb-0">You are only able to invite member that has registred in
                                nomads</p>
                        </div>
                    </div>
                </div>
